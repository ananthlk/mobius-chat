...
_ENRICHER_PREAMBLE = (
    ...
    "contains verbatim retrieved text (e.g. a founding essay). In your sections and bullets, quote this "
    "content directly — do NOT paraphrase, summarize, or substitute synonyms. You may break it into "
    "readable bullets and add a label, but every word must come from the source. "
    "direct_answer should be one sentence naming what the text is (e.g. 'From the Mobius founding essay:').\n"
