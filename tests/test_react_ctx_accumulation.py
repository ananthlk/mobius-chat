...
class TestCompletionGateCritic:
    ...
    Re-added here (2026-08-16) after the hook landed in react_loop.py
    via b4e09da -- originally pulled from the de1cf24 commit (see
    98c6ff1) because it depended on code that wasn't committed yet."""
